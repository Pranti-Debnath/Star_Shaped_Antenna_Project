...
'@ use template: Antenna - Planar_18.cfg
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "92", "54" 


'@ pick edge

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "91", "55" 


'@ chamfer edges of: component1:feed

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.ChamferEdge "0.6", "45", "False", "46" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickFaceFromId "component1:feed", "45" 
...
'@ define farfield monitor: farfield (f=34.84)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=34.84)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "34.84" 
     .ExportFarfieldSource "False" 
