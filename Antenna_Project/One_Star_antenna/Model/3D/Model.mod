...
'@ use template: Antenna - Planar_13.cfg
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "48", "26"

'@ pick edge

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "47", "27"

'@ chamfer edges of: component1:feed

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.ChamferEdge "0.6", "45", "False", "24"
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickFaceFromId "component1:feed", "23"
...
'@ define farfield monitor: farfield (f=38.22)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=38.22)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "38.22" 
     .ExportFarfieldSource "False" 
