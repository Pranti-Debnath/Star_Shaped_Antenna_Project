...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.ChamferEdge "0.6", "45", "False", "128"
...
'@ define farfield monitor: farfield (f=34.54)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=34.54)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "34.54" 
     .ExportFarfieldSource "False" 
...
'@ define farfield monitor: farfield (f=28.58)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=28.58)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "28.58" 
     .ExportFarfieldSource "False" 
     .UseSubvolume "False" 
     .Coordinates "Structure" 
     .SetSubvolume "-10", "10", "0", "20", "-0.823", "3.55289" 
     .SetSubvolumeOffset "10", "10", "10", "10", "10", "10" 
     .SetSubvolumeInflateWithOffset "False" 
     .SetSubvolumeOffsetType "FractionOfWavelength" 
     .EnableNearfieldCalculation "True" 
