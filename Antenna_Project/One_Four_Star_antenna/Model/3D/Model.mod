...
'@ use template: Antenna - Planar_15.cfg
...
'@ boolean add shapes: component1:solid1_1_1, component1:solid1_1_3

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.Add "component1:solid1_1_1", "component1:solid1_1_3" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "12", "2" 


'@ pick edge

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "11", "3" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "223", "139" 


'@ pick edge

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "224", "138" 


'@ chamfer edges of: component1:feed

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.ChamferEdge "0.6", "45", "False", "89" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickFaceFromId "component1:feed", "111" 
...
'@ define farfield monitor: farfield (f=28.28)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=28.28)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "28.28" 
     .ExportFarfieldSource "False" 
