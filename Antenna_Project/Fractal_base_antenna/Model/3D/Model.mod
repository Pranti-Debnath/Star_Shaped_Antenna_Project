...
'@ define farfield monitor: farfield (f=15.5)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=15.5)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "15.5" 
     .ExportFarfieldSource "False" 
...
'@ delete monitor: farfield (f=18)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Delete "farfield (f=18)" 
End With
...
'@ define farfield monitor: farfield (f=29.681)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=29.681)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "29.681" 
     .ExportFarfieldSource "False" 
