...
'@ use template: Antenna - Planar_17.cfg
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "135", "83" 


'@ pick edge

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickEdgeFromId "component1:feed", "136", "82" 


'@ chamfer edges of: component1:feed

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Solid.ChamferEdge "0.6", "45", "False", "49" 
...
'[VERSION]2020.0|29.0.1|20190925[/VERSION]
Pick.PickFaceFromId "component1:feed", "67" 
...
'@ define farfield monitor: farfield (f=26.58)

'[VERSION]2020.0|29.0.1|20190925[/VERSION]
With Monitor 
     .Reset 
     .Name "farfield (f=26.58)" 
     .Domain "Frequency" 
     .FieldType "Farfield" 
     .MonitorValue "26.58" 
     .ExportFarfieldSource "False" 
